...
parser.add_argument('--ckpt', default='vad_ckpt/checkpoint_0008.pth.tar', type=str)
...
parser.add_argument('--save_dir', default='D:/137/dataset/VAD/UCF_Crime/my_features/I3D-10crop/', type=str)
